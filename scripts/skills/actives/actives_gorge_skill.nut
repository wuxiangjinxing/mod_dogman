this.actives_gorge_skill <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.ridable_gorge";
		this.m.Name = "Gorge";
		this.m.Description = "";
	...
	local aaa = actor.getItems().getItemAtSlot(this.Const.ItemSlot.Accessory);	
			...
			if (spawnTile != null)
			{
				...
				aaa.m.Tail = this.WeakTableRef(this.Tactical.spawnEntity("scripts/entity/tactical/enemies/riding_lindwurm_tail", spawnTile.Coords.X, spawnTile.Coords.Y, this.getID()));
