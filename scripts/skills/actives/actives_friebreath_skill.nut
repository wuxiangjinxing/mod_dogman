this.actives_friebreath_skill <- this.inherit("scripts/skills/skill", {
	m = {
	...
	function create()
	{
		this.m.ID = "actives.fire_breath11";
	...
	function onUse( _user, _targetTile )
	{
	    ...
	    aaa.getTail().setFatigue(this.Math.max(0, aaa.getTail().getFatigue() + 25));
		aaa.m.Fatigue = this.Math.min(aaa.m.Fatigue2, aaa.m.Fatigue + 25);	
        this.m.Timefire = 0;		
		return true;
	}
