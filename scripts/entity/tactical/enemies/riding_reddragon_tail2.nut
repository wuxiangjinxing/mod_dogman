this.riding_reddragon_tail2 <- this.inherit("scripts/entity/tactical/actor", {
	m = {
		Body = null,
	},
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		if (_tile != null)
		{
			...
			decal = _tile.spawnDetail("bust_lindwurm_tail_03_dead", this.Const.Tactical.DetailFlag.Corpse, flip);
	...
	function onInit()
	{
		...
		body.setBrush("bust_lindwurm_tail_0" + this.Math.rand(3, 3));
		...
		injury.setBrush("bust_lindwurm_tail_03_injured");
