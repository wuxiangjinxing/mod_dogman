this.riding_lindwurm <- this.inherit("scripts/entity/tactical/actor", {
	m = {
		Tail = null,
		Item = null
	},
	...
	function onInit()
	{
		...
		if (this.m.Tail == null)
		{
			...
			if (spawnTile != null)
			{
				this.m.Tail = this.WeakTableRef(this.Tactical.spawnEntity("scripts/entity/tactical/enemies/riding_lindwurm_tail2", spawnTile.Coords.X, spawnTile.Coords.Y, this.getID()));
