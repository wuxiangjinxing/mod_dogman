this.warhorse_armor_03_upgrade <- this.inherit("scripts/items/item", {
	m = {
		StaminaModifier = -28,	
	},
	function create()
	{
		this.m.ID = "misc.warhorse_armor_03_upgrade";
		this.m.Name = "Warhorse Luxurious Plate Armor";
		this.m.Description = "A luxurious plate armor that can be donned by any warhorse to give it protection in combat.";
		this.m.Variant = 3;
		this.updateVariant();		
	...
	function onUse( _actor, _item = null )
	{
		...
		horse.m.ArmorScript = this.new("scripts/items/armor/special/warhorse_armor_03");
