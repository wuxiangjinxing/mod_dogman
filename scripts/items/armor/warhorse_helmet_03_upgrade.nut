this.warhorse_helmet_03_upgrade <- this.inherit("scripts/items/item", {
	m = {
		StaminaModifier = -7,
	},
	function create()
	{
		this.m.ID = "misc.warhorse_helmet_03_upgrade";
		this.m.Name = "Warhorse Leather Helmet";
		this.m.Description = "A leather helmet that can be donned by any warhorse to give it protection in combat.";
		this.m.Variant = 13;
		this.updateVariant();	
	...
	function onUse( _actor, _item = null )
	{
		...
		horse.m.HelmetScript = this.new("scripts/items/armor/special/warhorse_helmet_03");
