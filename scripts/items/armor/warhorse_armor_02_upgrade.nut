this.warhorse_armor_02_upgrade <- this.inherit("scripts/items/item", {
	m = {
		StaminaModifier = -18,	
	},
	function create()
	{
		this.m.ID = "misc.warhorse_armor_02_upgrade";
		this.m.Name = "Warhorse Scale Armor";
		this.m.Description = "A Scale Armor that can be donned by any warhorse to give it protection in combat.";
		this.m.Variant = 2;
		this.updateVariant();		
	...
	function onUse( _actor, _item = null )
	{
		...
		horse.m.ArmorScript = this.new("scripts/items/armor/special/warhorse_armor_02");
