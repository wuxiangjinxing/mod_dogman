this.warhorse_helmet_06_upgrade <- this.inherit("scripts/items/item", {
	m = {
		StaminaModifier = -15,
	},
	function create()
	{
		this.m.ID = "misc.warhorse_helmet_06_upgrade";
		this.m.Name = "Warhorse Heavy Plate Helmet";
		this.m.Description = "A heavy plate helmet that can be donned by any warhorse to give it protection in combat.";
		this.m.Variant = 16;
		this.updateVariant();	
	...
	function onUse( _actor, _item = null )
	{
		...
		horse.m.HelmetScript = this.new("scripts/items/armor/special/warhorse_helmet_06");
