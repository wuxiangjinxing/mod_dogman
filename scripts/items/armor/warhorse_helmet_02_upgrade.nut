this.warhorse_helmet_02_upgrade <- this.inherit("scripts/items/item", {
	m = {
		StaminaModifier = -4,
	},
	function create()
	{
		this.m.ID = "misc.warhorse_helmet_02_upgrade";
		this.m.Name = "Warhorse Hood";
		this.m.Description = "A colorful hood that can be donned by any warhorse to give it protection in combat.";
		this.m.Variant = this.Math.rand(4, 12);
		this.updateVariant();	
	...
	function onUse( _actor, _item = null )
	{
		...
		horse.m.HelmetScript = this.new("scripts/items/armor/special/warhorse_helmet_02");
