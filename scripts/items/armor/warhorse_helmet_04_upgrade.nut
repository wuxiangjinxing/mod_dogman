this.warhorse_helmet_04_upgrade <- this.inherit("scripts/items/item", {
	m = {
		StaminaModifier = -10,
	},
	function create()
	{
		this.m.ID = "misc.warhorse_helmet_04_upgrade";
		this.m.Name = "Warhorse Plate Helmet";
		this.m.Description = "A plate helmet that can be donned by any warhorse to give it protection in combat.";
		this.m.Variant = 14;
		this.updateVariant();	
	...
	{
		this.Sound.play("sounds/combat/armor_chainmail_impact_03.wav", this.Const.Sound.Volume.Inventory);
	}
	...
	function onUse( _actor, _item = null )
	{
		...
		horse.m.HelmetScript = this.new("scripts/items/armor/special/warhorse_helmet_04");
