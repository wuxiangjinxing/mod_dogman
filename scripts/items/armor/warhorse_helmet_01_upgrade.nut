this.warhorse_helmet_01_upgrade <- this.inherit("scripts/items/item", {
	m = {
		StaminaModifier = -2,
	},
	function create()
	{
		this.m.ID = "misc.warhorse_helmet_01_upgrade";
		this.m.Name = "Warhorse Rein";
		this.m.Description = "A simple rein that can be donned by any warhorse to give it protection in combat.";
	...
	function onUse( _actor, _item = null )
	{
		...
		horse.m.HelmetScript = this.new("scripts/items/armor/special/warhorse_helmet_01");
