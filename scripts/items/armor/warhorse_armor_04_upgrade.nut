this.warhorse_armor_04_upgrade <- this.inherit("scripts/items/item", {
	m = {
		StaminaModifier = -42,	
	},
	function create()
	{
		this.m.ID = "misc.warhorse_armor_04_upgrade";
		this.m.Name = "Warhorse Heavy Plate Armor";
		this.m.Description = "A Heavy Plate Armor that can be donned by any warhorse to give it protection in combat.";
		this.m.Variant = 4;
		this.updateVariant();		
	...
	function onUse( _actor, _item = null )
	{
		...
		horse.m.ArmorScript = this.new("scripts/items/armor/special/warhorse_armor_04");
